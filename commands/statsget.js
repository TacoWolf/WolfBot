...
function statsget(bot, user, userID, channelID, message) {
  ...
  for (var key in stats) {
    if (key == userID) {
      ...
      msg = '**Oh, hey, ' + '__' + userName + '__' + '!** Here are some statistics that I\'ve collected about you! <3 \n \n';
      ...
      } else if (userStats.hug >= 2) {
        msg += '- You\'ve hugged people like-... **' + userStats.hug + '** times. You must really like hugs~! \n';
      } else if (userStats.hug === undefined) {
      ...
      if (userStats.treats === 1) {
        msg += '- You\'ve given me... one treat. It was tasty! \u2764 \n';
...
module.exports = { command: statsget };